...
@AllArgsConstructor
@NoArgsConstructor
public class Dev081Entity {
    private String netIdDev = "169.254.45.112.1.1"; // 设备081对应的NetId
    ...
    private Integer lineNum = 48; //设备011中的线路条数
    private Integer nodeNum = 35; //设备011中的站点个数
