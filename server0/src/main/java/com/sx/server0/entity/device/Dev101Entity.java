...
@AllArgsConstructor
@NoArgsConstructor
public class Dev101Entity {
    private String netIdDev = "169.254.89.70.1.1"; // 设备101对应的NetId
    ...
    private Integer lineNum = 32; //设备011中的线路条数
    private Integer nodeNum = 25; //设备011中的站点个数
