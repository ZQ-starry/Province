...
@AllArgsConstructor
@NoArgsConstructor
public class Dev111Entity {
    private String netIdDev = "169.254.117.20.1.1"; // 设备0111对应的NetId
    ...
    private Integer lineNum = 40; //设备011中的线路条数
    private Integer nodeNum = 27; //设备011中的站点个数
    private Integer staNum = 22; // 设备011中的变电站的个数
    private Integer iLen = 88; // 设备011中的变电站电流的数据长度 staNum*4
}
