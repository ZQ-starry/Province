...
@AllArgsConstructor
@NoArgsConstructor
public class Dev121Entity {
    private String netIdDev = "169.254.223.200.1.1"; // 设备121对应的NetId
    ...
    private Integer lineNum = 35; //设备011中的线路条数
    private Integer nodeNum = 27; //设备011中的站点个数
    private Integer staNum = 25; // 设备011中的变电站的个数
    private Integer iLen = 100; // 设备011中的变电站电流的数据长度 staNum*4
}
